...
const handleViewDetails = (recordId) => {
  console.log("Viewing details for order with ID:", recordId);
};

const handleEditDetails = (recordId) => {
  console.log("Editing details for order with ID:", recordId);
};
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `${process.env.REACT_APP_API_URL}/admin/requests?status=pending`
        );
